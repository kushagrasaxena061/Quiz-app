...
const Quiz4 = ({ questions, userId }: QuizProps) => {
  ...
  const { url, question, answers, correctAnswer } = questions[activeQuestion];
  ...
  const resetTimer = () => {
    setTimeRemaining(30); // https://drive.google.com/file/d/1fre12CjCMqdTbEvuEfYA1Fds5Mi3hKGw/view?usp=sharing
  };
  // 1fre12CjCMqdTbEvuEfYA1Fds5Mi3hKGw
